...
module.exports = {
  updateSpecialTimesheet: async (ctx) => {
    try {
      console.log('CTX-updateSpecialTimesheet', ctx);
      ...
      // filter reports from invoice appsync call by reports that were flagged
      const filteredDocuments = childTimeSheetDoc.documents.filter((doc) => {
